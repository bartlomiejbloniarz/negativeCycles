...
do
  ...
  do
    ...
    ../output/goldberg-radzik-simplified-2.o -t < test.in 2>> goldberg-radzik-simplified_t.out
  ...
  #../output/goldberg-radzik.o -$5 < test.in 2>> goldberg-radzik.out
  ../output/goldberg-radzik-simplified-2.o -c < test.in 2>> goldberg-radzik-simplified_c.out
